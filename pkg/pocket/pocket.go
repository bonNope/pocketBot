...
// NewClient creates a new client instance with your botapp key (to generate key visit https://getpocket.com/developer/apps/)
...
// Authorize generates access token for user, that authorized in your botapp via link
